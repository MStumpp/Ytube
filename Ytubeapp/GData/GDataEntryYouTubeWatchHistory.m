...
//
//  GDataEntryYouTubeWatchHistory.m
//

#if !GDATA_REQUIRE_SERVICE_INCLUDES || GDATA_INCLUDE_YOUTUBE_SERVICE

#import "GDataEntryYouTubeWatchHistory.h"
#import "GDataYouTubeConstants.h"
#import "GDataYouTubeElements.h"

@implementation GDataEntryYouTubeWatchHistory

+ (GDataEntryYouTubeWatchHistory *)videoEntry {
    
    GDataEntryYouTubeWatchHistory *entry = [self object];
...
+ (NSString *)standardEntryKind {
    return kGDataCategoryYouTubeWatchHistory;
}
