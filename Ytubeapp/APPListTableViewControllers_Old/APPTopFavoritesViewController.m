//
//  APPTopFavoritesViewController.m
//  Ytubeapp
//
//  Created by Matthias Stumpp on 14.11.12.
//  Copyright (c) 2012 Matthias Stumpp. All rights reserved.
//

#import "APPTopFavoritesViewController.h"

@interface APPTopFavoritesViewController()
...
@implementation APPTopFavoritesViewController
...
{
    if (self.showMode)
        [self.contentManager topFavorites:self.showMode delegate:self didFinishSelector:@selector(reloadDataResponse:finishedWithFeed:error:)];
}
